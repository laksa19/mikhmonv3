...
<?php
  if($countcookies < 2 ){echo "$countcookies item";
  }elseif($countcookies > 1){
  echo "$countcookies items";};echo"</th>";
?>
...
<?php
	...
	echo "<tr>";
	echo "<td style='text-align:center;'><a  title='Remove ". $user . "' href='./app.php?remove-cookie=". $id . "&session=".$session."'><i class='fa fa-minus-square text-danger'></i></a></td>";
	echo "<td>" . $user. "</td>";
	echo "<td>" . $maca. "</td>";
	echo "<td>" . $domain . "</td>";
	echo "<td>" .$exp."</a></td>";
