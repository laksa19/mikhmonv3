...
<div class="card-header">
	<h3><i class=" fa fa-money"></i> Selling Report <?php echo $idhr.$idbl;?></h3>
</div>
<div class="card-body">
<div class="row">
	<div>
		...
		<div class="input-group mr-b-10">  
			...
			<select style="padding:5px;" class="group-item group-item-md" title="Month" id="M">
        			<?php 
        			$idbls =array(1=>"jan","feb","mar","apr","may", "jun","jul","aug","sep","oct", "nov","des");
			...
			<script type="text/javascript">
				...
				function filterR(){
					...
					if(D !== ""){
						window.location='./app.php?hotspot=selling&idhr='+M+'/'+D+'/'+Y+'&session=<?php echo $session;?>';
					}else if(D === ""){
						window.location='./app.php?hotspot=selling&idbl='+M+Y+'&session=<?php echo $session;?>';
					}
				}
			</script>
		</div>
